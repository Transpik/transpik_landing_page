            ...
            <div className="flex items-center w-9/12">
              <div className="flex flex-col lg:flex-row w-full items-start lg:items-center rounded bg-white">
                <div className="hidden lg:block h-0 lg:h-64">
                  <img className="block w-auto shadow rounded" src={Image} alt="Image"></img>
                </div>
                <div className="h-64">
                  <div className="bg-white shadow rounded pt-12 pb-6 lg:px-12 px-8">
                    ...
                    <div className="md:flex items-center mt-12">
                      <div className="md:w-72 flex flex-col">
                        ...
                        <input
                          tabIndex={0}
                          arial-label="Please input full name"
                          type="name"
                    ...
                    <div className="md:flex items-center mt-6">
                      <div className="md:w-72 flex flex-col">
                        ...
                        <input
                          tabIndex={0}
                          role="input"
                          arial-label="Please input work email"
                          type="name"
                          className="text-base leading-none text-gray-900 p-3 focus:oultine-none focus:border-orange-500 mt-4 bg-gray-50 border-b-2 rounded border-gray-300 placeholder-gray-300"
                    ...
                    <div className="md:flex items-center mt-6">
                      ...
                      <div className="md:w-72 flex flex-col md:ml-6 md:mt-0 mt-4">
                        ...
                        <input
                          tabIndex={0}
                          arial-label="Please enter password again"
                          type="name"
                          className="text-base leading-none text-gray-900 p-3 focus:oultine-none focus:border-orange-500 mt-4 bg-gray-50 border-b-2 rounded border-gray-300 placeholder-gray-300"
...
//       <div className="w-full lg:w-1/3 h-24 lg:h-64 border-t lg:border-t-0 lg:border-r lg:border-l lg:rounded-r bg-gray-100"></div>
//       <div className="w-full lg:w-2/3 h-64"></div>
//     </div>
//   </div> */}
//     {/* <div className="absolute top-40 bg-white shadow rounded py-12 lg:px-28 px-8">
//     <p className="md:text-3xl text-xl font-bold leading-7 text-center text-gray-700">
