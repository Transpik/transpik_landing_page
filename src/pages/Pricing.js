    ...
    return (
      <div className="bg-gradient-to-b from-light-orange to-[#fff9f700]">
        ...
        <div className="inline-block text-md text-left w-50 ml-96 mx-auto">
          <select className="form-select block rounded-lg w-auto h-12 ml-72 bg-orange hover:bg-[#FFFFFF] font-medium text-center text-[#FFFFFF] hover:text-orange border-2 border-orange shadow-lg hover:border-orange text-sm py-3 px-9 mt-4">
