      ...
      <div className="flex flex-col items-center justify-center container align-middle w-full h-screen bg-secondary-light_orange">
        <div className="flex flex-row items-center justify-around w-full h-screen">
          ...
          <div class="flex flex-col items-center shadow-xl w-[550px] h-[500px] bg-orange rounded-md">
            <div className='flex items-center justify-center w-full h-[80px] text-white  text-4xl font-bold'>Download Our App</div>
            <div className='flex items-center justify-center w-[500px] h-[160px]  text-white text-2xl'>Our mobile app is available on app store and google store. Delivery drivers are recommended to download this for a better experience.</div>
            <div className='flex flex-row items-center justify-between w-[500px] h-[220px] '>
              <div className='w-[200px] h-[200px] bg-white'>QR code..</div>
              <div className='flex flex-col justify-between w-[220px] h-[200px] '>
                <button>
